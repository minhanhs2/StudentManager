...
class MainActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    studentList.add("Tô Minh Ánh - 001")
    ...
    studentList.add("Nguyễn Văn An - 006")
    studentList.add("Lê Thị Bình - 007")
    studentList.add("Phạm Văn Cường - 008")
    studentList.add("Hồ Thị Dung - 009")
    studentList.add("Vũ Văn Giang - 010")
    studentList.add("Đặng Thị Hoa - 011")
    studentList.add("Trần Văn Hải - 012")
    studentList.add("Nguyễn Thị Lan - 013")
    studentList.add("Lý Văn Minh - 014")
    studentList.add("Hoàng Thị Ngân - 015")
